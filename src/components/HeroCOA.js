  ...
  return (
    <section className="">
      ...
      <div className="w-1/2 flex item-center justify-center">
        <button className="px-10 py-5 text-2xl mt-5 mx-5 rounded-md hover:bg-sky-500 bg-sky-400 transition-colors">
          Borrow Supplies
        </button>
        <button className="px-10 py-5 text-2xl mt-5 mx-5 border-2 border-solid rounded-md border-sky-100 hover:border-sky-500 transition-colors">
          Offer Supplies
        </button>
      </div>
    </section>
